...
process {
    ...
    try {
		...
		# Brad - debug - this gets the password correct.
		Write-Host -NoNewLine "deccryptedPass: "
		Write-Host "${decryptedPass}"
		...
		# Brad - original script was not writing the password. WTF? Also, plain text. Double Plus WTF Microsoft!
